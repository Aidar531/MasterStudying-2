...
public class Charts {
    ...
    private static double timeStep = 0.00025; // шаг построения графиков  0.00025 - 80 т.за период 0.001 - 20 т.за период
    ...
    public Charts(){
        ...
        chart = new JFreeChart("Сигнал защиты", plot);
        chart.setBorderPaint(Color.black);
        chart.setBorderVisible(true);
        chart.setBackgroundPaint(Color.white);

        frame = new JFrame("Сигнал защиты");
